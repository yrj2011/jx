...
func TestEnsureDevEnvironmentSetup(t *testing.T) {
	...
	assert.Equal(t, []jenkinsio_v1.QuickStartLocation{{GitURL: "http://github.com", GitKind: "github", Owner: "jenkins-x-quickstarts", Includes: []string{"*"}, Excludes: []string{"WIP-*"}}}, env.Spec.TeamSettings.QuickstartLocations)
