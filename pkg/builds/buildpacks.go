...
const (
	...
	ClassicWorkloadBuildPackURL = "http://192.168.1.228:1080/jenkins-x-buildpacks/jenkins-x-classic.git"
	...
	KubernetesWorkloadBuildPackURL = "http://192.168.1.228:1080/jenkins-x-buildpacks/jenkins-x-kubernetes.git"
