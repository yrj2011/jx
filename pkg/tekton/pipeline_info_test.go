	...
	testCases := []struct {
		...
		expected: &tekton.PipelineRunInfo{
			...
			GitInfo: &gits.GitRepository{
				...
				Project:      "abayer",
				Scheme:       "https",
				URL:          "http://github.com/abayer/jx-demo-qs",
			},
			GitURL:       "http://github.com/abayer/jx-demo-qs",
		...
		expected: &tekton.PipelineRunInfo{
			...
			GitInfo: &gits.GitRepository{
				...
				Project:      "abayer",
				Scheme:       "https",
				URL:          "http://github.com/abayer/js-test-repo",
			},
			GitURL:       "http://github.com/abayer/js-test-repo",
